...
public class OAuthClientImplementation implements OAuthClient {
	...
	public OAuthClientImplementation(String podIdentifier, String clientId, String clientSecret, String refreshToken) {
		this.podIdentifier = podIdentifier;
		this.clientId = clientId;
		this.clientSecret = clientSecret;
		this.refreshToken = refreshToken;
		this.accessUrl = Pod.getOAuthEndpoint(podIdentifier);
	}
