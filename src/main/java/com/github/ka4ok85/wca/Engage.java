...
public class Engage {
	...
	public Engage(String podIdentifier, String clientId, String clientSecret, String refreshToken) {
		this.oAuthClient = new OAuthClientImplementation(podIdentifier, clientId, clientSecret, refreshToken);
